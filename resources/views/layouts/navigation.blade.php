<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('asignaciones.index')" :active="request()->routeIs('asignaciones.index')">
                {{ __('Asignaciones') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('asignaciones.create')" :active="request()->routeIs('asignaciones.create')">
                {{ __('Crear asignación') }}
            </x-responsive-nav-link>
        </div>
